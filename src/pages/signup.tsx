...
const SignUpPage = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    role: Yup.string().required("Please select a role").oneOf(['individual', 'organization'], "Invalid role selected"),
  });
                        ...
                        <div className="flex items-center space-x-2 rounded-md border p-3 cursor-pointer hover:bg-accent">
                          ...
                          <Label htmlFor="individual" className="flex-1 cursor-pointer">
                            ...
                            <div className="text-sm text-muted-foreground">
                              I want to discover and apply for opportunities
                            </div>
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2 rounded-md border p-3 cursor-pointer hover:bg-accent">
                          ...
                          <Label htmlFor="organization" className="flex-1 cursor-pointer">
                            ...
                            <div className="text-sm text-muted-foreground">
                              I want to create and manage opportunities
                            </div>
                          </Label>
                        </div>
                      </RadioGroup>
                      {formik.touched.role && formik.errors.role && (
                        <p className="text-destructive text-xs">{formik.errors.role}</p>
                      )}
                    </div>
